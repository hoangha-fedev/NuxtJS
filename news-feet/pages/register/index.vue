<template>
  <div class="md-layout md-alignment-center-center" style="height: 100vh">
    <md-card class="md-layout-item md-size-50">
      <md-card-header class="md-title">Register</md-card-header>
        ...
        <md-card-content>
          <md-field md-clearable :class="getValidationClass('email')">
            ...
            <md-input
              ...
              v-model="form.email"
            ></md-input>
            <span class="md-error" v-if="!$v.form.email.required">This email id required</span>
          ...
          <md-field :class="getValidationClass('password')">
            ...
            ></md-input>
            <span class="md-error" v-if="!$v.form.password.required">This password id required</span>
...
// import { required, email, minLength, maxlength } from 'vuelidate/lib/validates'
