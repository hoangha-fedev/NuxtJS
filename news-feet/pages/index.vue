<template>
    <div class="md-layout md-alignment-center" style="margin: 4em 0">
      ...
      <md-drawer class="md-right" md-fixed :md-active.sync="showRightSidepanel">
        ...
        <md-progress-bar v-if="loading" md-mode="indeteminate"></md-progress-bar>
      ...
      <div class="md-layout-item md-size-95">
        <md-content class="md-layout md-gutter" style="background: #007998; padding: 1em; flex-wrap: wrap">
          <ul
            class="md-layout-item md-large-size-48 md-medium-size-45 md-small-size-50 md-xsmall-size-100"
  ...
  data() {
    return {
      ...
      newsCategories: [
        ...
        {name: 'Entertaiment', path: 'entertaiment', icon: 'weekend'},
...
.md-layout-item{flex-basis: 25%; flex-wrap: wrap}
.fixed-toolbar {position: fixed; top: 0; z-index: 5;}
</style>